$(document).ready(function () { 
    ...
    const dataTable = $('#celulaDatatables').DataTable({
        ...
        ajax: {
            method: "GET",
            url: 'http://localhost/AppwebMVC/CCrecimiento/Listar',
    ...
    $('#celulaDatatables tbody').on('click', '#eliminar', function () {
        ...
        swalWithBootstrapButtons.fire({
            ...
            html: '<spam id="idCelulaCrecimientoE"></spam>',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                document.getElementById('idCelulaCrecimientoE').textContent = datos.id;
                let id = document.getElementById('idCelulaCrecimientoE').textContent;
