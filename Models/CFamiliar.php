...
class CFamiliar extends Model

{   
   

    public  function registrar_CFamiliar($nombre, $idLider, $idCoLider, $idTerritorio){
        try {
    ...
    public  function listar_CFamiliar()
    {
    ...
    public  function editar_CFamiliar($id, $nombre, $idLider, $idCoLider, $idTerritorio)
    {
    ...
    public  function eliminar_CFamiliar($id)
    {
