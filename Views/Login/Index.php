    ...
    <div class="row h-100">
        <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center align-items-center flex-column">
            <div class="d-flex flex-column text-center mb-3">
                <h1 id="bienvenida1">INICIO DE SESION</h1>
                <h3 id="bienvenida2">Bienvenidos a Llamas de Fuego</h3>
            </div>
                    ...
                    <form action="<?= LOCAL_DIR ?>Login" class="mt-4" method="post" id="loginForm">
                        <div class="d-grid gap-4 mb-5">
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <input type="text" class="inputLogin" name="cedula" maxlength="8" required>
                            </div>

                            <div class="d-flex flex-column align-items-center">
                                <label class="form-label text-white fw-bold">Clave</label>
                                <input type="password" class="inputLogin" name="clave" maxlength="10" required>
                            </div>
                        </div>
