...
<script>
    const permisos = {
        registrar: <?php echo $usuario->tienePermiso("celulaConsolidacion", "registrar") ?>,
        consultar: <?php echo $usuario->tienePermiso("celulaConsolidacion", "consultar") ?>,
        actualizar: <?php echo $usuario->tienePermiso("celulaConsolidacion", "actualizar") ?>,
        eliminar: <?php echo $usuario->tienePermiso("celulaConsolidacion", "eliminar") ?>
    }
</script>
                ...
                <table id="celulaDatatables" class="table table-bordered table-hover">
                    <thead>
                        ...
                        <div class="d-flex align-items-end justify-content-between mb-2">
                            <h2><strong>Celulas de Consolidacion:</strong></h2>
                        ...
                        <div class="mb-3">
                            <form id="formularioReunion">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="alert alert-danger d-flex align-items-center mt-3 d-none" id="msj_discipulos" role="alert">
                                        Debe seleccionar discipulos para la asistencia.
                                    </div>
                                </div>
