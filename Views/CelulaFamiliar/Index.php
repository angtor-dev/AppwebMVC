...
<script>
    const permisos = {
        registrar: <?php echo $usuario->tienePermiso("celulaFamiliar", "registrar") ? 1 : 0 ?>,
        consultar: <?php echo $usuario->tienePermiso("celulaFamiliar", "consultar") ? 1 : 0 ?>,
        actualizar: <?php echo $usuario->tienePermiso("celulaFamiliar", "actualizar") ? 1 : 0 ?>,
        eliminar: <?php echo $usuario->tienePermiso("celulaFamiliar", "eliminar") ? 1 : 0 ?>
    }
</script>

<div class="page-top d-flex align-items-end justify-content-between mb-2">
<h2><strong>Celula Familiar</strong></h2>
    <div class="d-flex gap-3">
        <div class="buscador">
            <input type="text" id="search" class="form-control" placeholder="Buscar Celula">
        </div>
        <?php if ($usuarioSesion->tienePermiso("celulaFamiliar", "registrar")): ?>
                        ...
                        <div class="mb-3">
                            <form id="formulario">
                                <div class="mb-3 col-12">
                                    ...
                                    <input type="text" class="form-control" id="nombre" maxlength="50" name="nombre" aria-describedby="msj_nombre">
                        ...
                        <div class="mb-3">
                            <form id="formulario2">
                                <div class="mb-3 col-12">
                                    ...
                                    <input type="text" class="form-control" id="nombre2" maxlength="50" name="nombre2" aria-describedby="msj_nombre2">
