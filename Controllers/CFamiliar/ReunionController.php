...
if (isset($_GET['cargar_data'])) {  
    //Primero inicializamos las variables
     $Lista = $CFamiliar->listar_reuniones();
...
if (isset($_POST['editar'])) { 
   ...
   $CFamiliar->editar_reuniones($id, $idCelulaFamiliar, $fecha, $tematica, $semana, $generosidad, $infantil, $juvenil, $adulto, $actividad, $observaciones);
...
if (isset($_POST['eliminar'])) {   
   ...
   $CFamiliar->eliminar_reuniones($id);
...
if (isset($_GET['listarcelulas'])) {  
    ...
    $listaCelulas = $CFamiliar->listar_celulas();
