...
if (isset($_GET['cargar_data'])) {  
    //Primero inicializamos las variables
     $Lista = $CCrecimiento->listar_CCrecimiento();
...
if (isset($_POST['registroreunion'])) { 
   ...
   $CCrecimiento->registrar_reunion($idCelulaCrecimiento, $fecha, $tematica, $semana, $generosidad, $infantil, $juvenil, $adulto, $actividad, $observaciones);
...
if (isset($_POST['eliminar'])) {   
   ...
   $CCrecimiento->eliminar_CCrecimiento($id);
