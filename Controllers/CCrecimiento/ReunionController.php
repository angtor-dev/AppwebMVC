...
if (isset($_GET['cargar_data'])) {  
    //Primero inicializamos las variables
     $Lista = $CCrecimiento->listar_reuniones();
...
if (isset($_POST['editar'])) { 
   ...
   $CCrecimiento->editar_reuniones($id, $idCelulaCrecimiento, $fecha, $tematica, $semana, $generosidad, $infantil, $juvenil, $adulto, $actividad, $observaciones);
...
if (isset($_POST['eliminar'])) {   
   ...
   $CCrecimiento->eliminar_reuniones($id);
...
if (isset($_GET['listarcelulas'])) {  
    ...
    $listaCelulas = $CCrecimiento->listar_celulas();
